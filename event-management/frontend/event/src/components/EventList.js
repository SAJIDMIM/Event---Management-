...
const EventList = ({ events, deleteEvent, editEvent, setCurrentView, currentView }) => {
            ...
            <div className="events-grid" ref={gridRef}>
              {events.map((event) => (
                <div className="event-card" key={event._id}>
                  ...
                  <p className="event-detail"><strong>Date:</strong> {event.date.split("T")[0]}</p>
                  <p className="event-detail"><strong>Venue:</strong> {event.venue}</p>
                  <p className="event-detail"><strong>Capacity:</strong> {event.capacity}</p>
